...
import cn.renlm.micro.core.authentication.DeviceClientAuthenticationProvider;
import cn.renlm.micro.core.federation.FederatedIdentityIdTokenCustomizer;
import cn.renlm.micro.core.jose.Jwks;
import cn.renlm.micro.core.web.authentication.DeviceClientAuthenticationConverter;
...
public class AuthorizationServerConfig {
	...
	public SecurityFilterChain authorizationServerSecurityFilterChain(
		...
		/*
		 * This cn.renlm.micro.core demonstrates the use of a public client that does not
		 ...
		 * outside the scope of this cn.renlm.micro.core.
		 */
		...
		RegisteredClient mtlsDemoClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.clientSettings(
						ClientSettings.builder()
								.x509CertificateSubjectDN("CN=demo-client-cn.renlm.micro.core,OU=Spring cn.renlm.micro.cores,O=Spring,C=US")
